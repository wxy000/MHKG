...
urlpatterns = [
    ...
    path('admin_views/doctorList/shenhe/', doctorList_view.shenhe),
    path('admin_views/doctorList/updateAuditing/', doctorList_view.updateAuditing),
    path('admin_views/doctorList/del/', doctorList_view.delDoctor),
    path('admin_views/doctorList/batchDel/', doctorList_view.batchDelDoctor),
    ...
    path('doctor/inquiry/setAnswerQiuzhu/', inquiry_view.setAnswerQiuzhu),
