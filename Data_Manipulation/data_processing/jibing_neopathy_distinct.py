...
entity = list()
resultJsonFile = codecs.open(os.path.join(local_url, 'jibing_neopathy_corrected.json'), 'w', encoding='utf-8')
with open(os.path.join(local_url, 'jibing_neopathy.json'), 'r') as f:
